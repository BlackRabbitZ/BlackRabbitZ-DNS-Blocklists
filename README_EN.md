...
| 🔴 **Ultimate** | Maximum | **5,333,227** | Aggressive filtering | [Show Parts](#ultimate-parts) | **[Raw Parts](#ultimate-parts)** |
<!-- MAIN_PROFILES_END -->
...
| Profile | Protection | Entries | Recommended for | View | Raw |
|---|:---:|---:|---|:---:|:---:|
| 🛡️ **Security** | Security | **3,499,019** | Security-focused filtering | [Show Parts](#security-parts) | **[Raw Parts](#security-parts)** |
| 👨‍👩‍👧 **Family** | Family | **1,911,286** | Family networks | [Show Parts](#family-parts) | **[Raw Parts](#family-parts)** |
<!-- ADDON_PROFILES_END -->
...
**Total: 1,911,286 unique domains.** Add all parts to Pi-hole or your DNS blocker for complete profile coverage.

| Family Part | Family Part |
|---|---|
| **Part 01**  <br>**1,911,286** entries · 34.7 MiB  <br>[View](lists/combined/family-part-01.txt) · **[Raw](https://raw.githubusercontent.com/BlackRabbitZ/BlackRabbitZ-DNS-Blocklists/main/lists/combined/family-part-01.txt)** |  |
...
**Total: 5,333,227 unique domains.** Add all parts to Pi-hole or your DNS blocker for complete profile coverage.

| Ultimate Part | Ultimate Part |
|---|---|
| **Part 01**  <br>**2,637,500** entries · 50.0 MiB  <br>[View](lists/combined/ultimate-part-01.txt) · **[Raw](https://raw.githubusercontent.com/BlackRabbitZ/BlackRabbitZ-DNS-Blocklists/main/lists/combined/ultimate-part-01.txt)** | **Part 02**  <br>**2,589,347** entries · 50.0 MiB  <br>[View](lists/combined/ultimate-part-02.txt) · **[Raw](https://raw.githubusercontent.com/BlackRabbitZ/BlackRabbitZ-DNS-Blocklists/main/lists/combined/ultimate-part-02.txt)** |
| **Part 03**  <br>**106,380** entries · 1.7 MiB  <br>[View](lists/combined/ultimate-part-03.txt) · **[Raw](https://raw.githubusercontent.com/BlackRabbitZ/BlackRabbitZ-DNS-Blocklists/main/lists/combined/ultimate-part-03.txt)** |  |
...
| List | Entries | Description | View | Raw |
|---|---:|---|:---:|:---:|
| 🦠 **Malware** | 2,751,063 | Massive malware, ransomware and active malware-host set | [View](lists/categories/malware.txt) | [Raw](https://raw.githubusercontent.com/BlackRabbitZ/BlackRabbitZ-DNS-Blocklists/main/lists/categories/malware.txt) |
...
| 💰 **Scam & Internet Fraud** | 284,239 | Scam, fraud, fake-offer, trap and deceptive-platform domains | [View](lists/categories/scam.txt) | [Raw](https://raw.githubusercontent.com/BlackRabbitZ/BlackRabbitZ-DNS-Blocklists/main/lists/categories/scam.txt) |
...
| 🎰 **Gambling** | 512,362 | Massive betting, casino and gambling domain set · [optional variants](#list-gambling-variants) | [View](lists/categories/gambling.txt) | [Raw](https://raw.githubusercontent.com/BlackRabbitZ/BlackRabbitZ-DNS-Blocklists/main/lists/categories/gambling.txt) |
