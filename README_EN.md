...
| 🔴 **Ultimate** | Maximum | **5,327,013** | Aggressive filtering | [Show Parts](#ultimate-parts) | **[Raw Parts](#ultimate-parts)** |
<!-- MAIN_PROFILES_END -->
...
| Profile | Protection | Entries | Recommended for | View | Raw |
|---|:---:|---:|---|:---:|:---:|
| 🛡️ **Security** | Security | **3,497,288** | Security-focused filtering | [Show Parts](#security-parts) | **[Raw Parts](#security-parts)** |
| 👨‍👩‍👧 **Family** | Family | **1,906,794** | Family networks | [Show Parts](#family-parts) | **[Raw Parts](#family-parts)** |
<!-- ADDON_PROFILES_END -->
...
**Total: 3,497,288 unique domains.** Add all parts to Pi-hole or your DNS blocker for complete profile coverage.

| Security Part | Security Part |
|---|---|
| **Part 01**  <br>**2,581,997** entries · 50.0 MiB  <br>[View](lists/combined/security-part-01.txt) · **[Raw](https://raw.githubusercontent.com/BlackRabbitZ/BlackRabbitZ-DNS-Blocklists/main/lists/combined/security-part-01.txt)** | **Part 02**  <br>**915,291** entries · 18.2 MiB  <br>[View](lists/combined/security-part-02.txt) · **[Raw](https://raw.githubusercontent.com/BlackRabbitZ/BlackRabbitZ-DNS-Blocklists/main/lists/combined/security-part-02.txt)** |
...
**Total: 1,906,794 unique domains.** Add all parts to Pi-hole or your DNS blocker for complete profile coverage.

| Family Part | Family Part |
|---|---|
| **Part 01**  <br>**1,906,794** entries · 34.7 MiB  <br>[View](lists/combined/family-part-01.txt) · **[Raw](https://raw.githubusercontent.com/BlackRabbitZ/BlackRabbitZ-DNS-Blocklists/main/lists/combined/family-part-01.txt)** |  |
...
**Total: 5,327,013 unique domains.** Add all parts to Pi-hole or your DNS blocker for complete profile coverage.

| Ultimate Part | Ultimate Part |
|---|---|
| **Part 01**  <br>**2,637,226** entries · 50.0 MiB  <br>[View](lists/combined/ultimate-part-01.txt) · **[Raw](https://raw.githubusercontent.com/BlackRabbitZ/BlackRabbitZ-DNS-Blocklists/main/lists/combined/ultimate-part-01.txt)** | **Part 02**  <br>**2,590,141** entries · 50.0 MiB  <br>[View](lists/combined/ultimate-part-02.txt) · **[Raw](https://raw.githubusercontent.com/BlackRabbitZ/BlackRabbitZ-DNS-Blocklists/main/lists/combined/ultimate-part-02.txt)** |
| **Part 03**  <br>**99,646** entries · 1.6 MiB  <br>[View](lists/combined/ultimate-part-03.txt) · **[Raw](https://raw.githubusercontent.com/BlackRabbitZ/BlackRabbitZ-DNS-Blocklists/main/lists/combined/ultimate-part-03.txt)** |  |
...
| List | Entries | Description | View | Raw |
|---|---:|---|:---:|:---:|
| 🦠 **Malware** | 2,749,335 | Massive malware, ransomware and active malware-host set | [View](lists/categories/malware.txt) | [Raw](https://raw.githubusercontent.com/BlackRabbitZ/BlackRabbitZ-DNS-Blocklists/main/lists/categories/malware.txt) |
...
| 💰 **Scam & Internet Fraud** | 284,235 | Scam, fraud, fake-offer, trap and deceptive-platform domains | [View](lists/categories/scam.txt) | [Raw](https://raw.githubusercontent.com/BlackRabbitZ/BlackRabbitZ-DNS-Blocklists/main/lists/categories/scam.txt) |
| 🛒 **Fake Shops** | 11,451 | Aggressive fake-shop/deceptive-store candidate set | [View](lists/categories/fake-shops.txt) | [Raw](https://raw.githubusercontent.com/BlackRabbitZ/BlackRabbitZ-DNS-Blocklists/main/lists/categories/fake-shops.txt) |
...
| List | Entries | Description | View | Raw |
|---|---:|---|:---:|:---:|
| 🔞 **Adult / NSFW** | 1,028,855 | Massive adult/NSFW-content and pornography domain set | [View](lists/categories/adult.txt) | [Raw](https://raw.githubusercontent.com/BlackRabbitZ/BlackRabbitZ-DNS-Blocklists/main/lists/categories/adult.txt) |
